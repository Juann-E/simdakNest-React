...
@Controller('satuan-barang-stock-pangan')
@UseGuards(JwtAuthGuard, RolesGuard)
export class SatuanBarangStockPanganController {
  constructor(private readonly satuanBarangService: SatuanBarangStockPanganService) {}
