        ...
        <section className="container mx-auto px-4 sm:px-6">
          ...
          <div className="w-full">
            <div className="h-[500px] rounded-lg overflow-hidden shadow-lg">
              {/* Mengirim semua data pasar ke komponen MapSection.
                Pastikan komponen MapSection bisa menerima props 'locations' 
                dan menampilkan semua marker.
              */}
              <MapSection locations={markets.map(market => ({
                id: market.id,
